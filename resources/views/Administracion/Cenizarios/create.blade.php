		...
		<div class="card-body card-padding">
				...
				<div class="col-sm-12 col-md-2 col-lg-2">
					<div class="form-group fg-float">
						<div class="fg-line">
							...
							<label class="fg-label">Numero del ceniario</label>
						</div>
					</div>
				</div>
			</div>
			<div class="row">
				<div class="col-sm-12 col-md-12 col-lg-6">
					<div class="form-group fg-float">
						<div class="fg-line">
							<input type="text" class="form-control fg-input" v-model="cenizario.fallecido_nombres.nombres" v-on:keyup="concatenarFallecido">
				...
				<div class="col-sm-12 col-md-12 col-lg-6">
					<div class="form-group fg-float">
						<div class="fg-line">
							<input type="text" class="form-control fg-input" v-model="cenizario.fallecido_nombres.apellidos" v-on:keyup="concatenarFallecido">
		...
		<div class="card-body card-padding">
			...
			<div class="row">
				<div class="col-sm-12 col-md-12 col-lg-6">
					<div class="form-group fg-float">
						<div class="fg-line">
							<input type="text" class="form-control fg-input" v-model="cenizario.comprador_nombres.nombres" v-on:keyup="concatenarComprador">
				...
				<div class="col-sm-12 col-md-12 col-lg-6">
					<div class="form-group fg-float">
						<div class="fg-line">
							<input type="text" class="form-control fg-input" v-model="cenizario.comprador_nombres.apellidos" v-on:keyup="concatenarComprador">
